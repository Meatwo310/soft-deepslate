...
public class SoftDeepslate {
    ...
    public static class ModEventSubscriber {
        ...
        public static void onBlockBreakSpeed(PlayerEvent.BreakSpeed event) {
            ...
            if (blocksCache.contains(blockID)) {
                event.setNewSpeed((float) (event.getOriginalSpeed() * ServerConfigs.multiplierEntry.get()));
            }
        }
    ...
    public static void reload() {
        List<? extends String> blockIDs = ServerConfigs.blockIDsEntry.get();
        List<? extends String> blockTags = ServerConfigs.blockTags.get();
