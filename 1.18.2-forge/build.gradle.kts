...
val minecraftVersionRange = "[1.18.2, 1.19)"
val forgeVersion = "40.2.21"
val forgeVersionRange = "[40.2.21,)"
val loaderVersionRange = "[40,)"
val parchmentMinecraftVersion = "1.18.2"
val parchmentMappingsVersion = "2022.11.06"
...
dependencies {
    ...
    implementation(project(":1.18.2-common"))
...
legacyForge {
    ...
    mods {
        create(modId) {
            ...
            sourceSet(project(":1.18.2-common").sourceSets.main.get())
        }
    }
}
