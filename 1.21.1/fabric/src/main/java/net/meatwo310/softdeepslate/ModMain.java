...
public class ModMain implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        NeoForgeModConfigEvents.loading(Constants.MODID).register(config -> LOGIC.invalidateBlockCache());
        NeoForgeModConfigEvents.reloading(Constants.MODID).register(config -> LOGIC.invalidateBlockCache());
